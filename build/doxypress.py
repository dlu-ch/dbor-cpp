...
class Template(string.Template):  # like dlb_contrib.Template
...
class DoxyPress(dlb.ex.Tool):
    ...
    def update_replacements(self, replacements: Dict[str, Any]) -> Dict[str, Any]:
        return replacements
    ...
    async def redo(self, result, context):
        ...
        with context.temporary() as projectfile, context.temporary(is_dir=True) as output_directory:
            ...
            replacements = _transform_replacement(self.update_replacements(replacements), context)
